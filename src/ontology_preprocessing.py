...
def load_chebi(path='http://purl.obolibrary.org/obo/chebi.obo'):
    ...
    graph.add_node('BE:00000',
                   name='ROOT')  # biomedical entity general root concept
    graph.add_edge('CHEBI:24431', 'BE:00000',
                   edgetype='is_a')  # chemical_entity
    ...
    print('Done:', len(name_to_id), 'IDs with', len(synonym_to_id),
          'synonyms.')
...
def load_go(path='http://purl.obolibrary.org/obo/go.obo'):
    ...
    graph.add_node('BE:00000',
                   name='ROOT')  # biomedical entity general root concept
    graph.add_edge('GO:0008150', 'BE:00000',
                   edgetype='is_a')  # biological_process
